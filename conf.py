...
# and displayed underneath the tag list or index pageâ€™s title.
# (translatable)
# TAG_DESCRIPTIONS = {
#    DEFAULT_LANG: {
...
# Format: a list of dicts {language: translation, language2: translation2, â€¦}
# For example:
#   [
...
#  this affects only 'output/categories/cat_news'
...
GLOBAL_CONTEXT = {
    'header_logo': '<img src="/images/header-logo.png" id="logo" alt="wxPython header logo" />'
}
